    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-background-dark flex items-center justify-center p-4 font-display">
      ...
      <div className="w-full max-w-[440px] bg-white dark:bg-slate-900 rounded-xl shadow-xl shadow-blue-500/5 overflow-hidden border border-slate-100 dark:border-slate-800">
        ...
        <div className="px-8 pb-10">
          {/* Error Message */}
          {error && (
            <div className="mb-5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 px-4 py-3 rounded-lg text-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            {/* Login Button */}
            <button
              className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3.5 rounded-lg shadow-md shadow-primary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              type="submit"
              disabled={isLoading}
            >
